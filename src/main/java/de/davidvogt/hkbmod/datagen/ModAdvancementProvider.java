...
public class ModAdvancementProvider implements AdvancementSubProvider {
    ...
    public void generate(@Nonnull HolderLookup.Provider registries, @Nonnull Consumer<AdvancementHolder> saver) {
        ...
        addImpossibleAdvancement(saver, "archer/level_1", "archer/level_0", Items.CROSSBOW, AdvancementType.TASK);
        addImpossibleAdvancement(saver, "archer/level_2", "archer/level_1", Items.SPECTRAL_ARROW, AdvancementType.TASK);
