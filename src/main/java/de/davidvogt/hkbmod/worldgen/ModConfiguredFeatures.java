...
public class ModConfiguredFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, ROBINIA_KEY, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
                ...
                BlockStateProvider.simple(ModBlocks.ROBINIA_LEAVES.get()),
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath(HKBMod.MODID, name));
    }
